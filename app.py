...
with st.sidebar:
    ...
    # Image 2: Your second image (img1)
    st.image("img1.png", use_container_width=True)

    st.markdown("## ♻️ Smart Waste Analytics Dashboard")

    st.markdown(
        """
        **Nur Ain binti Roslan**  
        SD23027 · Universiti Malaysia Pahang Al-Sultan Abdullah (UMPSA)  
        2025/2026
        """
    )
    ...
    st.caption(
        "Data source: Ministry of Housing and Local Government (MHLG) & SWCorp Malaysia  \n"
        "Period: 2019–2023"
    )
